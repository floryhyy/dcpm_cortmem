...
# alt vis (for paper) plotting model success vs null distribution
```{r}
...
dev.off()
```
# alt vis (for paper) generalization across construct
```{r}
...
dev.off()
```
# alt vis (for paper) generalization across stim
```{r}
